...
current position, permanently, in the bottom-left corner of the screen.
...
- The readout always sits in the bottom-left corner; repositioning and a
  show/hide hotkey are being considered for a future update.
